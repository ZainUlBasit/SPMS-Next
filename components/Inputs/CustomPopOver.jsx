...
const CustomPopOver = ({ label, placeholder, Value, onClick }) => {
  return (
    ...
    >
      ...
      <div className="px-3 py-2 pr-10 border border-[#0E2480] rounded-[7.94px] w-full outline-none cursor-pointer shadow-[#0e25802d_0px_2px_8px_0px] h-full flex items-center">
